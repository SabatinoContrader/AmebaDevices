...
<body>
     	...
     	<jsp:param name="operation" value="ReadThing"/>
	   	...
	   	<div >
	<div class="insertDiv">
		<img src="https://png2.kisspng.com/20180509/che/kisspng-computer-icons-building-cube-clip-art-5af29b46688608.6583202015258489024281.png"
			class="imgThing" > <a href="Thing?operation=create"
			class="customerLink">Inserisci Thing </a>
	</div>
		<div class="insertDiv">
		<img src="https://www.nerdhead.net/wp-content/uploads/2017/03/blue-282x300.png"
			class="imgThing" > <a href="Thing?operation=update"
			class="customerLink">Modifica Thing </a>
	</div>
		<div class="insertDiv">
		<img src="https://cdn4.iconfinder.com/data/icons/logistic-delivery-20/40/Remove_box_cancel_delete_delivery-512.png"
